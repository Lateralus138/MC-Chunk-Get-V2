...
exe = EXE(pyz,
          ...
          strip=False,
          upx=True,
          console=False , icon='mc_chunk_get.ico')
coll = COLLECT(exe,
               a.binaries,
               a.zipfiles,
               a.datas,
